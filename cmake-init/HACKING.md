...
hidden if the `cmake-init_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cmake-init_DEVELOPER_MODE` to the configure
...
Runs the executable target `cmake-init_exe`.
